...
class HL23VIP:
    ...
    def simply_passive(self):
        ...
        for sec in self.all:
            sec.Ra = 100
            for seg in sec:
                seg.g_pas = 2.5756438955642182e-05
    ...
    def general_mech(self):
        ...
        for sec in self.all:
            ...
            sec.Ra = 100
            sec.cm = 2
            sec.e_pas = -79.74132024971513
            sec.g_pas = 2.5756438955642182e-05
    ...
    def soma_mech(self):
        ...
        for sec in self.soma:
            ...
            for seg in sec:
                ...
                seg.ek = -85
                seg.ena = 50
                seg.gbar_NaTg = 0.11491205828369114
                seg.vshiftm_NaTg = 13
                seg.vshifth_NaTg = 15
                seg.slopem_NaTg = 7
                seg.slopeh_NaTg = 6
                seg.gbar_Nap = 0.0001895305240694194
                seg.gbar_K_P = 0.0009925418924114282
                seg.gbar_K_T = 0.009051981253674193
                seg.gbar_Kv3_1 = 0.31215653649208114
                seg.gbar_SK = 0.1655502166633749
                seg.gbar_Im = 0.0003679378262289559
                seg.gbar_Ca_HVA = 4.384846294634834e-05
                seg.gbar_Ca_LVA = 0.0034472458995879864
                seg.gamma_CaDynamics = 0.0005
                seg.decay_CaDynamics = 25.159166441555044
    ...
    def axon_mech(self):
        ...
        for sec in self.axon:
            ...
            for seg in sec:
                ...
                seg.ek = -85
                seg.ena = 50
                seg.gbar_NaTg = 0.20112200814143477
                seg.vshiftm_NaTg = 0
                seg.vshifth_NaTg = 10
                seg.slopem_NaTg = 9
                seg.slopeh_NaTg = 6
                seg.gbar_Nap = 0.0006248906854665301
                seg.gbar_K_P = 0.26489876414660096
                seg.gbar_K_T = 0.014364427062274185
                seg.gbar_Kv3_1 = 0.0011201608191112877
                seg.gbar_SK = 0.7027792087501376
                seg.gbar_Im = 0.00013891465461042372
                seg.gbar_Ca_HVA = 2.819397237794038e-05
                seg.gbar_Ca_LVA = 0.010354001513952075
                seg.gamma_CaDynamics = 0.0005
                seg.decay_CaDynamics = 75.78875619470153
